<div wire:key="{{ $todo->id }}"
    ...
    <div class="flex justify-between space-x-2">
            ...
            @if ($editingTodoID == $todo->id)
                <div class="">
                    <input wire:model="editingTodoName" type="text" placeholder="Todo.."
                        class="bg-gray-100  text-gray-900 text-sm rounded block w-full p-2.5" value="">
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click="delete({{ $todo->id }})" wire:confirm="Are you sure you want to delete this todo?"
